...
// No bottom nav — just two always-visible buttons in the header:
//   [ 📋 Collection ]  [ 🔒 Admin ]
// Follows the glassmorphism light-mode UI style.
// ---------------------------------------------------------------------
      ...
      <body className="bg-slate-50 text-slate-900 font-sans antialiased min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-violet-50/50 bg-fixed">
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 border-b border-slate-200 backdrop-blur-md shadow-sm">
          <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between gap-3">
            ...
            {/* Right side — two navigation buttons */}
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200
                           active:bg-slate-300 border border-slate-200
                           text-slate-700 text-xs font-bold px-3.5 py-2 rounded-xl
              ...
              <Link
                ...
                className="flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800
                           active:bg-black text-white text-xs font-bold px-3.5 py-2
                           rounded-xl transition-colors touch-manipulation shadow-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
        ...
        {/* ---------------------------------------------------------- */}
        {/* MAIN CONTENT                                                */}
        {/* pt-20 clears the fixed header. pb-8 gives bottom breathing  */}
        {/* room without a bottom nav bar.                              */}
        {/* ---------------------------------------------------------- */}
        <main className="pt-20 pb-8 min-h-screen max-w-lg mx-auto px-4">
          {children}
        </main>
